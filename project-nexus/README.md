...
### 开发规范
`.kiro/steering/` 目录下的详细开发指南：
- [项目概览](/.kiro/steering/project-overview.md) - 架构与功能
- [代码规范](/.kiro/steering/code-standards.md) - 编码约定
- [组件模式](/.kiro/steering/component-patterns.md) - React 最佳实践
- [数据库模式](/.kiro/steering/database-patterns.md) - Prisma 指南
- [AI 集成](/.kiro/steering/ai-integration.md) - AI 实现指南
- [外部 API](/.kiro/steering/external-apis.md) - API 集成模式
- [认证](/.kiro/steering/authentication.md) - 认证与授权
- [测试指南](/.kiro/steering/testing-guide.md) - 测试策略
- [入门指南](/.kiro/steering/GETTING_STARTED.md) - 新手引导

### 功能文档
- [Bilibili 集成](/doc/BILIBILI_INTEGRATION_SUMMARY.md)
- [计时器标签识别](/TIMER_TAG_RECOGNITION_IMPLEMENTATION.md)
- [藏宝阁增强](/VERIFY_TREASURE_EXIT_FIX.md)
...
3. 遵循[代码规范](/.kiro/steering/code-standards.md)
4. 为新功能编写测试
...
**注意**: 这是一个个人效率平台。如需设置帮助，请参阅[入门指南](/.kiro/steering/GETTING_STARTED.md)。
